...
# ~~ LINKING ~~
main.x: main.o analysis_m.o init_conditions_mod.o integrators_mod.o mathutils_m.o thermodynamics_m.o thermostats_m.o writers_mod.o
...
thermodynamics_m.o: thermodynamics_m.F90
	$(FC) $(EFLAGS) $(FFLAGS) $(DFLAGS) $(PFLAGS) -c $^
